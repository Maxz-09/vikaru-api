    ...
    switch (selectedOption) {
        ...
        case "chatgpt":
            apiInfoDiv.innerHTML =
                ...
                '<p><strong>Headers:</strong><br><p></p>( REPLIES ) - Optional, to send a custom replies message. Available variables: %response%.<p></p><br>( API ) - Optional, to get a ChatGPT response from the selected API type. Available types: Akhiro, ngodingaja, nyx_gpt4, nyx_gpt, and nyx_turbo.<p></p><br>( EXPERIMENTAL ) - Optional, for experimental use. Enter "true" to use it.<p></p></br>( REGEX ) - Must if use EXPERIMENTAL, to combine REGEX and messages.<p></p></br>( ARG1 ) - Must if using EXPERIMENTAL, to retrieve messages in a capture group to use as argument.</p>';
